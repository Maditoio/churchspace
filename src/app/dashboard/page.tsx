...
export default async function DashboardPage({
  ...
  searchParams?: Promise<{ enquiriesPage?: string }>;
}) {
  ...
  const [totalListings, activeListings, totalEnquiries, savedByOthers, viewAggregate] = await Promise.all([
  ...
  const [listings, recentEnquiries] = await Promise.all([
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link href="/dashboard/notifications"><Button variant="secondary">View Notifications</Button></Link>
